...
import { CourseStructuredData } from "../../components/global";
            ...
            >
              <div className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full whitespace-nowrap inline-flex items-center justify-center gap-2 px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-primary-600 to-primary-700 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    <>
            ...
            >
              <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-xl p-6 border border-primary-100">
                ...
                <p className="text-dark-600">
                  A personalized certificate with your wisdom score, degree
                  level, and chosen module. Share your achievement on social
                  media and join the community of wise individuals!
                </p>
              </div>
            </motion.div>
          </motion.div>
